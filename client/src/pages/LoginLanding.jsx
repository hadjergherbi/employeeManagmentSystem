    ...
    const portalOptions =[
        {
            to:"/login/admin",
            title:"Admin Portal",
            description:"Manage employees,departments, payroll, and system configuations.",
            icon: ShieldIcon
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        {/* Header 
        mb=margin bottom 
        md applies on medium screens and the text will be on left */}
        
        <div className="mb-10 text-center md:text-left">
            {/*tracking tight is for reducing the space between letters*/}
        ...
        <div className="space-y-4">
            {portalOptions.map((portal)=>(
                ...
                className="group block bg-slate-50 border border-slate-200 rounded0lg p-5 sm:p-6 transition-all duration-300 hover:border-indigo-400 hover:bg-indigo-50">
                    <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
                        <h3 className="text-lg text-slate-800 group-hover:text-indigo-600 mb-1 transition-colors">{portal.title}
